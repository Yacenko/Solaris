    ...
    <div id="top-section">	
		<header id="masthead" class="site-header" role="banner">
			...
			<div class="site-branding">
				<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo home_url( '/' ); ?>wp-content/themes/sixteen/images/solyaris1.png"></a></h1>
		...
		<div id="nav-wrapper">
				<nav id="site-navigation" class="main-navigation" role="navigation">
						...
						<?php wp_nav_menu( array('menu' => 'bottom') ); ?>
